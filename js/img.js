...
Amplification.prototype = {
    ...
    SmallMove() {
        ...
        this.smallimg.onmousemove = function (e) {
            ...
            _this.span.style.left = e.clientX - 50 + 'px';
            _this.span.style.top = e.clientY - 50 + 'px';
            this.smallleft = _this.span.offsetLeft;
            this.smalltop = _this.span.offsetTop;
            if(this.smallleft<=0){
                _this.span.style.left = 0 +'px';
            }
            if(this.smallleft>=200){
                _this.span.style.left = 200 +'px';
            }
            if(this.smalltop<=0){
                _this.span.style.top = 0 +'px';
            }
            if(this.smalltop>=200){
                _this.span.style.top = 200 +'px';
            }
